  ...
  return {
    ...
    JSXText: {
      enter: function enter(astPath) {
        ...
        var node = astPath.node,
            parent = astPath.parent;
        var envOpts = state.opts || opts;
        var propsMap = envOpts.componentPropsMap || _defaults.GETTEXT_COMPONENT_PROPS_MAP; // Using fragment short syntax <>...</> yields JSXText paths with
    ...
    JSXExpressionContainer: {
      enter: function enter(astPath) {
        ...
        if (parent.openingElement === undefined || parent.openingElement.type !== 'JSXOpeningElement' || (0, _nodeHelpers.isGettextComponent)(Object.keys(propsMap), parent.openingElement) === false) {
          return;
        }
